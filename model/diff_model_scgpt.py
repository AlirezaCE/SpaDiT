...
class DiT_diff(nn.Module):
    def __init__(self,
        ...
        if use_scgpt and scgpt_model_dir is not None:
            print(f"[INFO] Using scGPT embedder from {scgpt_model_dir}")
            ...
            print("[INFO] Using standard embedding for condition")
    ...
    def forward(self, x, x_hat, t, y, z=None, gene_ids=None, **kwargs):
        """
        Args:
